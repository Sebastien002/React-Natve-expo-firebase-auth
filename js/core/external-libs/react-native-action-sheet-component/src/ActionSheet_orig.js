...
class ActionSheet extends Component {
    ...
    setActionSheetState (toValue: number, callback?: Function = () => {}): void {
        ...
        Animated.timing(this.state.transformOffsetY, {
            toValue:this.getNormalizedHeight(toValue),//toValue,
            duration,
    ...
    getActionSheetHeight = (e: any): void => {
        ...
        let {transformOffsetY}  = this.props;
    ...
    renderItems (): ReactElement {
        ...
        return Children.map(children, (child,index) => {
            ...
            return (
                <View style={[propStyles.itemStyle]}>
                    {item}
                    {separator}
                </View>
            )
            ...
            <View style={[styles.container]}>
                ...
                <Animated.View
                    style={[
                        ...
                        propStyles.customActionSheetView /* customActionSheetView added by Laxaar*/
                    ]}
                >
                    <ScrollView style={[styles.scrollView, scrollViewStyle]}>
                        <View onLayout={this.getActionSheetHeight} style={[itemsStyle,propStyles.thumbnailActionSheetView]}>
                            {this.renderItems()}
                        </View>
                    </ScrollView>
                </Animated.View>
